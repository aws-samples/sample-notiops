...
export const STRINGS: Dict = {
  ...
  "notif.empty": {
    zh: "暂无通知。当 CloudWatch 告警、健康事件、备份失败等发生时，会在这里出现。",
    en: "No notifications yet. CloudWatch alarms, health events, backup failures and more will show up here.",
  },
  ...
  "notif.section.other": { zh: "其他事件通知", en: "Other event alerts" },
  "notif.section.otherSub": { zh: "CloudWatch 告警 / 备份 / GuardDuty 等", en: "CloudWatch alarms / Backup / GuardDuty, etc." },
  // 两层目录左侧子导航分组
